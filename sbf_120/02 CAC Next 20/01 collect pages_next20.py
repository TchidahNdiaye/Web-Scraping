    ...
    while i<5:
        ...
        if j==1000:
            if req.status_code==200:
                content=req.text
                with open('pages_next20/'+k+'.txt','w',encoding='utf8') as output:
...
C'est une société qui est côtée sur plusieurs places boursières
Pour prendre spécifiquement les informations de euronext Paris
il faut utiliser le second.
'fmc-technologies-inc?cid=7006'
'''
